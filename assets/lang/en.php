...
$text = [
    ...
    'bandplan' => 'Band Plan',
    'bandplan-title' => 'View the current band plan for individual IARU bands.',
    'cw-encoder' => 'Morse encoder',
    'cw-encoder-title' => 'Create morse code from text, play it or download as a WAV file.',
    'cw-decoder' => 'Morse decoder',
    'cw-decoder-title' => 'Decode morse code via microphone or WAV file.',
    'time' => 'Time',
    ...
    'cw-enc-rise'            => 'Rise (ms)',
    'cw-enc-amp'             => 'Volume',
    'cw-enc-word-gap'        => 'Word gap',
    'cw-enc-btn-play'        => 'Play',
    'cw-enc-btn-stop'        => 'Stop',
    'cw-enc-btn-wav'         => 'Download WAV',
    'cw-enc-btn-clear'       => 'Clear',
    'cw-enc-output-panel'    => 'Morse code',
    ...
    'cw-dec-symbol-panel'    => 'Current symbol',
    'cw-dec-decoded-panel'   => 'Decoded text',
    'cw-dec-source-label'    => 'Audio source',
    'cw-dec-source-mic'      => 'Microphone',
    'cw-dec-source-file'     => 'WAV file',
    'cw-dec-freq-label'      => 'Tone frequency (Hz)',
    'cw-dec-threshold-label' => 'Signal threshold',
    'cw-dec-wpm-label'       => 'Speed (WPM)',
    'cw-dec-bandwidth-label' => 'Bandwidth (Hz)',
    'cw-dec-squelch-label'   => 'Squelch (dB SNR)',
    'cw-dec-autotune-label'  => 'Auto-tune',
    'cw-dec-agc-label'       => 'AGC',
    'cw-dec-monitor-label'   => 'Monitor audio',
    'cw-dec-btn-start'       => 'Start',
    'cw-dec-btn-stop'        => 'Stop',
    'cw-dec-btn-clear'       => 'Clear text',
    'cw-dec-btn-find'        => 'Find tone',
    'cw-dec-strength-label'  => 'Signal strength',
    'cw-dec-freq-det-label'  => 'Frequency',
    'cw-dec-snr-label'       => 'SNR',
    'cw-dec-dot-label'       => 'Dot',
    'cw-dec-state-label'     => 'State',
    'cw-dec-file-hint'       => 'Drag & drop WAV or click to browse',
    'cw-dec-file-choose'     => 'Choose WAV file',
    'cw-dec-waiting'         => 'Waiting for signal...',
    'cw-dec-requesting-mic'  => 'Requesting microphone access...',
    'cw-dec-mic-active'      => 'Microphone active:',
    'cw-dec-stopped'         => 'Stopped',
    'cw-dec-stopped-cached'  => 'Stopped (microphone cached)',
    'cw-dec-wav-ready'       => 'WAV ready:',
    'cw-dec-wav-start'       => 'Playing WAV file...',
    'cw-dec-mic-mode'        => 'Microphone selected',
    'cw-dec-no-file'         => 'No file loaded',
    'cw-dec-err-secure'      => 'Microphone requires secure connection',
