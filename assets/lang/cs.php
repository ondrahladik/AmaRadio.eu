...
$text = [
    ...
    'bandplan' => 'Band Plan',
    'bandplan-title' => 'Zobraz si aktuální band plan pro jednotlivá IARU pásma.',
    'cw-encoder' => 'Morse enkodér',
    'cw-encoder-title' => 'Vytvoř si morseovku z textu, přehraj ji či stáhni jako WAV soubor.',
    'cw-decoder' => 'Morse dekodér',
    'cw-decoder-title' => 'Dekóduj morseovku přes mikrofon či WAV soubor.',
    'time' => 'Hodiny',
    ...
    'cluster-col-date'    => 'Datum',
    'cluster-col-time'    => 'Čas',
    ...
    'cw-enc-freq'            => 'Tón (Hz)',
    'cw-enc-rise'            => 'Náběh (ms)',
    'cw-enc-amp'             => 'Hlasitost',
    'cw-enc-word-gap'        => 'Mezislovní mezera',
    'cw-enc-btn-play'        => 'Přehrát',
    'cw-enc-btn-stop'        => 'Zastavit',
    'cw-enc-btn-wav'         => 'Stáhnout WAV',
    'cw-enc-btn-clear'       => 'Vymazat',
    'cw-enc-output-panel'    => 'Morseova abeceda',
    ...
    'cw-dec-symbol-panel'    => 'Aktuální symbol',
    'cw-dec-decoded-panel'   => 'Dekódovaný text',
    'cw-dec-source-label'    => 'Zdroj zvuku',
    'cw-dec-source-mic'      => 'Mikrofon',
    'cw-dec-source-file'     => 'WAV soubor',
    'cw-dec-freq-label'      => 'Frekvence tónu (Hz)',
    'cw-dec-threshold-label' => 'Práh signálu',
    'cw-dec-wpm-label'       => 'Rychlost (WPM)',
    'cw-dec-bandwidth-label' => 'Šířka pásma (Hz)',
    'cw-dec-squelch-label'   => 'Squelch (dB SNR)',
    'cw-dec-autotune-label'  => 'Auto-ladění',
    'cw-dec-agc-label'       => 'AGC',
    'cw-dec-monitor-label'   => 'Monitorovat zvuk',
    'cw-dec-btn-start'       => 'Spustit',
    'cw-dec-btn-stop'        => 'Zastavit',
    'cw-dec-btn-clear'       => 'Vymazat text',
    'cw-dec-btn-find'        => 'Najít tón',
    'cw-dec-strength-label'  => 'Síla signálu',
    'cw-dec-freq-det-label'  => 'Frekvence',
    'cw-dec-snr-label'       => 'SNR',
    'cw-dec-dot-label'       => 'Tečka',
    'cw-dec-state-label'     => 'Stav',
    'cw-dec-file-hint'       => 'Přetáhněte WAV nebo klikněte pro výběr',
    'cw-dec-file-choose'     => 'Vybrat WAV soubor',
    'cw-dec-waiting'         => 'Čeká na signál...',
    'cw-dec-requesting-mic'  => 'Žádám o přístup k mikrofonu...',
    'cw-dec-mic-active'      => 'Mikrofon aktivní:',
    'cw-dec-stopped'         => 'Zastaveno',
    'cw-dec-stopped-cached'  => 'Zastaveno (mikrofon uložen)',
    'cw-dec-wav-ready'       => 'WAV připraven:',
    'cw-dec-wav-start'       => 'Přehrávám WAV soubor...',
    'cw-dec-mic-mode'        => 'Mikrofon vybrán',
    'cw-dec-no-file'         => 'Žádný soubor nenačten',
    'cw-dec-err-secure'      => 'Mikrofon vyžaduje zabezpečené připojení',
